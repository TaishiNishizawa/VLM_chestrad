...
from mimicvlm.report_generation.report_gen import run_labels_report_gen
...
def main():
    ...
    if args.limit:
        image_dataset = torch.utils.data.Subset(image_dataset_filtered, range(args.limit))
        embedding_dataset = torch.utils.data.Subset(embedding_dataset, range(args.limit))

    image_dataloader = DataLoader(
        image_dataset_filtered,
